		...
		if (successResult === true) {
			switch (entityName) {
				case 'SalesOrderHeader':
					action = context.executeAction('/SalesOrdersOnline/Actions/SalesOrder/CreateUpdateDelete/SOHeaderDelete.action');
					break;
				case 'SalesOrderItem':
					action = context.executeAction('/SalesOrdersOnline/Actions/SalesOrder/CreateUpdateDelete/SOItemDelete.action');
					break;
				default:
					break;
			}
