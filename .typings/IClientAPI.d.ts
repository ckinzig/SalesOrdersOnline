...
interface IClientAPI {
  ...
  formatDate(date: Date, customLocale?: string, customTimeZone?: string): string;
  // Display in datetime format
  formatDatetime(date: Date, customLocale?: string, customTimeZone?: string): string;
  ...
  formatTime(date: Date, customLocale?: string, customTimeZone?: string): string;
...
interface IFormCellProxy extends IControlProxy {
   ...
   */
  setTargetSpecifier(target: IFormCellTargetProxy): Promise<any>;
